...
public class UserTest {
    ...
    public void testUserRoles() {
        ...
        Assert.assertEquals(
                "Creating a user should result in its presence in the database",
                1,
                service.count());
        ...
        Assert.assertEquals(
                "Creating multiple users should save them as expected", 3, service.count());
        ...
        Assert.assertTrue(
                "A user with multiple roles should identify as a Doctor properly",
                user3.isDoctor());
    }
