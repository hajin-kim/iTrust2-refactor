...
public class HCPEditPatientStepDefs extends CucumberTest {
    ...
    public void loadRequiredUsers() {
        ...
        final Patient nsanderson =
                new Patient(new UserForm("nsanderson", "123456", Role.ROLE_PATIENT, 1));
    ...
    public void gotoEditPage() {
        ...
        ((JavascriptExecutor) driver)
                .executeScript("document.getElementById('editPatientDemographics').click();");
    }
    ...
    public void checkWarningMessage(final String first, final String last) throws Exception {
        ...
        ((JavascriptExecutor) driver)
                .executeScript(
                        "window.confirm = function(msg) {"
                            + " document.getElementById('header0').textContent = msg; return true;"
                            + " };");
        ...
        try {
            ...
            assertTrue(
                    driver.findElement(By.id("header0"))
                            .getText()
                            .contains("You have made changes"));
