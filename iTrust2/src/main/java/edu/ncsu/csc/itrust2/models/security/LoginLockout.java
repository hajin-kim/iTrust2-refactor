...
public class LoginLockout extends DomainObject {
    ...
    /**
     * Returns the user associated with the lockout, or null if this is an IP lockout.
     *
     * @return the user
     */
    public User getUser() {
    ...
    /**
     * Returns the IP associated with the lockout, or null if this is a User lockout.
     *
     * @return the ip
     */
    public String getIp() {
