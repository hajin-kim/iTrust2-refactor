...
/**
 * Logging class to handle saving log-worthy events and for retrieving those that previously
 * occurred. All actions that need to be logged (as defined in the iTrust Wiki) should be logged
 * using one of the three `Log` methods here.
 *
...
public class LoggerUtil {
    ...
    /**
     * Most complete logger utility. Usually won't need all of this information, but if you do, it
     * has it all. The time of the event is added automatically and is assumed to be the current
     * time.
     *
     * @param code The TransactionType of the event that occurred
     * @param primaryUser The primary user involved in the event that was logged.
     * @param secondaryUser An (optional) secondary user involved in the event.
     * @param message An (optional) message for further details.
     */
    public void log(
     ...
     * @param code The TransactionType of the event that occurred
     * @param primaryUser The primary user involved in the event that was logged.
     * @param message A message for further details
     */
     ...
     *
     * @param code The type of event that occurred
     * @param primaryUser The Primary User involved
     */
     ...
     *
     * @param user User to find LogEntries for
     ...
     *
     * @param user The User to retrieve log entries for
     ...
     *
     * @param user User to find LogEntries for
     * @param top Number of events to find
     * @return A List of the LogEntry Entries for the user. If the number of Entries is less than
     *     `top`, returns all
     */
     ...
     *
     * @param code The type of event that occurred
     * @param primary The primary user involved
     * @param secondary The secondary user involved
     */
