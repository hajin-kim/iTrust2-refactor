...
public class OfficeVisit extends DomainObject {
     ...
     *
     * @param patient the patient to set this office visit to
     */
     ...
     *
     * @param hcp the hcp to set this office visit to
     */
     ...
     *
     * @param date the date to set this office visit to
     */
     ...
     *
     * @param id the id to set this office visit to
     */
     ...
     *
     * @param type the type to set this office visit to
     */
     ...
     *
     * @param hospital the hospital to set this office visit to
     */
     ...
     *
     * @param notes the notes to set this office visit to
     */
     ...
     *
     * @param appointment the appointment to set this office visit to
     */
     ...
     *
     * @param basicHealthMetrics the basicHealthMetrics to set
     */
     ...
     *
     * @param list The List of Diagnoses
     */
