...
public class Personnel extends User {
     ...
     *
     * @param firstName the first name to set this personnel to
     */
     ...
     *
     * @param lastName the last name to set this personnel to
     */
     ...
     *
     * @param address1 the address line 1 to set this personnel to
     */
     ...
     *
     * @param address2 the address line 2 to set this personnel to
     */
     ...
     *
     * @param city the city of residence to set this personnel to
     */
     ...
     *
     * @param state the state of residence to set this personnel to
     */
     ...
     *
     * @param zip the zipcode to set this personnel to
     */
     ...
     *
     * @param phone the phone number to set this personnel to
     */
     ...
     *
     * @param email the email to set this personnel to
     */
