...
public class PatientForm {
     ...
     *
     * @param patient the patient object to set the form with
     */
    ...
    @Length(min = 2, max = 2) private String state;
