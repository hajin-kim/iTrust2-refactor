...
public class LocalDateAdapter implements JsonSerializer<LocalDate>, JsonDeserializer<LocalDate> {
    ...
    /**
     * Deserialization function for Gson to create a LocalDate object from an ISO date String.
     *
    ...
    /**
     * Serialization function for Gson to convert a LocalDate object to an ISO date String.
     *
